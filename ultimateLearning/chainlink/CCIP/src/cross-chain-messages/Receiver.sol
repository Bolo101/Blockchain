...
contract Receiver is CCIPReceiver, Ownable {
    ...
    error Receiver__NotAllowedForSourceChainOrSenderAddress(
    ...
    constructor()
        CCIPReceiver(0xD3b06cEbF099CE7DA4AcCf578aaebFDBd6e88a93)
        Ownable(msg.sender)
    {}
    ...
    modifier onlyAllowlisted(uint64 _sourceChainSelector, address _sender) {
        ...
        if (
            _sourceChainSelector != SOURCE_CHAIN_SELECTOR || _sender != s_sender
        ) {
            revert Receiver__NotAllowedForSourceChainOrSenderAddress(
